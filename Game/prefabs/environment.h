...
std::shared_ptr<GameObject> createEnvironment(std::shared_ptr<GameWorld> gameWorld, std::shared_ptr<Screen> screen, std::string shape, std::string material = "", std::shared_ptr<ModelTransform> transform = nullptr)
{
