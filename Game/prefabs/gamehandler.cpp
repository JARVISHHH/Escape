...
std::shared_ptr<GameObject> createGameHandler(std::shared_ptr<GameWorld> gameWorld, float maxTime, std::shared_ptr<UIElement> time, std::shared_ptr<UIElement> resultImage, std::shared_ptr<UIElement> scoreImage)
{
	...
	std::shared_ptr<GameHandlerComponent> gameHandlerComponent = std::make_shared<GameHandlerComponent>(maxTime, time, resultImage, scoreImage);
